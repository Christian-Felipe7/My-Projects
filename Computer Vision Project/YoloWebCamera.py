...
with open('C:\\Users\\felip\\OpenCVYolo\\OpenCVYolo\\yoloDados\\YoloNames.names') as f:
    # cria uma lista com todos os nomes
    labels = [line.strip() for line in f]

# carrega os arquivos treinados pelo framework
network = cv2.dnn.readNetFromDarknet('C:\\Users\\felip\\OpenCVYolo\\OpenCVYolo\\yoloDados\\yolov3.cfg','C:\\Users\\felip\\OpenCVYolo\\OpenCVYolo\\yoloDados\\yolov3.weights')
